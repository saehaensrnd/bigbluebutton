...
async function main() {
    ...
    try{
        ...
        await page.waitForSelector('[aria-label="듣기만"]');
        await page.click('[aria-label="듣기만"]', {waitUntil: 'domcontentloaded'});
	await page.waitForSelector('[aria-label="취소"]');
        await page.click('[aria-label="취소"]', {waitUntil: 'domcontentloaded'});
